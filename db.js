...
async function init() {
  ...
  await execMany([
    ...
    `INSERT OR IGNORE INTO staff (id, name, role, pin_hash) VALUES ('DOZACOFFEE', 'Doza Cloud Admin', 'admin', '$2b$10$IFRg/Kx1mZtpUvHL4QPuD.Icm9uSymC3Z4rcbhRiU9L7bC/qdaO/i')`,
    // --- SEED MENU ---
    ...
    // --- UPDATES ---
    `UPDATE staff SET pin_hash = '$2b$10$IFRg/Kx1mZtpUvHL4QPuD.Icm9uSymC3Z4rcbhRiU9L7bC/qdaO/i' WHERE id = 'DOZACOFFEE'`,
